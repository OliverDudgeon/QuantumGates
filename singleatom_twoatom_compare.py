...
sol2 = solve_twoatom(laser=1, detuning_1=0.5,
                     detuning_2=0.5, tf=10, init=[1+0j, 0+0j, 0+0j, 0+0j], V=0)
...
axs[0].set(xlabel='Time, $t$',ylabel='Probability Amplitude')
axs[1].set(xlabel='Time, $t$',ylabel='Probability Amplitude')
